...
alias label="${JIRA_ADD_ON_SCRIPTS_PATH}/jira-add-same-label.sh"
alias multilabel="${JIRA_ADD_ON_SCRIPTS_PATH}/jira-add-multiple-labels.sh"
alias label121="${JIRA_ADD_ON_SCRIPTS_PATH}/jira-add-distinct-labels.sh"
